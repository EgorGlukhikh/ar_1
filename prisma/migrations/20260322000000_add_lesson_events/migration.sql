...
CREATE TABLE IF NOT EXISTS "LessonEvent" (
    "id"        TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS "LessonEvent_lessonId_event_idx" ON "LessonEvent"("lessonId", "event");
CREATE INDEX IF NOT EXISTS "LessonEvent_userId_lessonId_idx" ON "LessonEvent"("userId", "lessonId");
